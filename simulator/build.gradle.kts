...
dependencies {
    val kotlinReactVersion = "17.0.1-pre.144-kotlin-1.4.30"
    ...
    implementation(name = "kotlin-styled", version = "5.2.0-pre.144-kotlin-1.4.21", group = "org.jetbrains")
    implementation(name = "kotlin-css-js", version = "1.0.0-pre.144-kotlin-1.4.30", group = "org.jetbrains")
    implementation(name = "kotlin-extensions", version = "1.0.1-pre.144-kotlin-1.4.21", group = "org.jetbrains")
