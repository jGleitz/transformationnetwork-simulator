...
dependencies {
    val kotlinReactVersion = "16.13.1-pre.100-kotlin-1.3.72"
    ...
    val kotlinCssVersion = "1.0.0-pre.101-kotlin-1.3.72"
    ...
    implementation(name = "kotlin-extensions", version = "1.0.1-pre.100-kotlin-1.3.72", group = "org.jetbrains")
