...
dependencies {
    ...
    implementation(name = "kotlin-styled", version = "5.2.0-pre.135-kotlin-1.4.21", group = "org.jetbrains")
    implementation(name = "kotlin-css-js", version = "1.0.0-pre.136-kotlin-1.4.21", group = "org.jetbrains")
    implementation(name = "kotlin-extensions", version = "1.0.1-pre.136-kotlin-1.4.21", group = "org.jetbrains")
