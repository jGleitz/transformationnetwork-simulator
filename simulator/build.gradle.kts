...
dependencies {
    val kotlinReactVersion = "16.13.1-pre.120-kotlin-1.4.10"
    ...
    implementation(name = "kotlin-styled", version = "5.2.0-pre.119-kotlin-1.4.10", group = "org.jetbrains")
    implementation(name = "kotlin-css-js", version = "1.0.0-pre.120-kotlin-1.4.10", group = "org.jetbrains")
