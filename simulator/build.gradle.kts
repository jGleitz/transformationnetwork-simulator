...
dependencies {
    implementation(name = "kotlin-react-dom", version = "16.13.0-pre.93-kotlin-1.3.70", group = "org.jetbrains")
    implementation(name = "kotlin-styled", version = "1.0.0-pre.93-kotlin-1.3.70", group = "org.jetbrains")
