...
dependencies {
    ...
    implementation(name = "kotlin-styled", version = "5.2.0-pre.123-kotlin-1.4.10", group = "org.jetbrains")
    implementation(name = "kotlin-css-js", version = "1.0.0-pre.124-kotlin-1.4.10", group = "org.jetbrains")
    implementation(name = "kotlin-extensions", version = "1.0.1-pre.123-kotlin-1.4.10", group = "org.jetbrains")
