...
dependencies {
    val kotlinReactVersion = "16.13.1-pre.112-kotlin-1.4.0"
    ...
    val kotlinCssVersion = "1.0.0-pre.112-kotlin-1.4.0"
    ...
    implementation(name = "kotlin-extensions", version = "1.0.1-pre.112-kotlin-1.4.0", group = "org.jetbrains")
