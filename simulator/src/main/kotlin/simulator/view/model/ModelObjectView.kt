...
private object ModelObjectStyles : StyleSheet("ModelObjectStyles", isStatic = true) {
    val attributesTable by css {
        borderCollapse = collapse
        borderTopWidth = 1.px
        borderTopStyle = solid
        borderTopColor = Colors.borderColor
        marginTop = baseSpacing * 0.5
    }
            ...
            modelObject.metaclass.attributes.forEach { attribute ->
                styledTr {
                    ...
                    styledTd {
                        ...
                        styledValue(modelObject.attributes[attribute])
                    }
                }
            }
        }
